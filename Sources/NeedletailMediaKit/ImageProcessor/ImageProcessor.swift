...
@globalActor public actor ImageProcessorActor {
    public static let shared = ImageProcessorActor()
    public init() {}
}
...
extension ImageProcessor {
    ...
    public enum BlurState: Sendable {
        ...
        public mutating func blurBackground(_ pixels: CVPixelBuffer, ciContext: CIContext) async throws -> (CIImage, CVPixelBuffer) {
        ...
        @available(iOS 16.0, macOS 13, *)
        public mutating func setBlur(with
        ...
        @available(iOS 16.0, macOS 13, *)
        private mutating func applyBlur(_ cgimage: CGImage, sourceBuffer: vImage_Buffer, format: vImage_CGImageFormat) async throws -> CGImage {
        ...
        @available(iOS 16.0, macOS 13, *)
        private mutating func hann1D(_ cgImage: CGImage, sourceBuffer: vImage_Buffer, format: vImage_CGImageFormat) {
        ...
        private mutating func hann2D(sourceBuffer: vImage_Buffer, format: vImage_CGImageFormat) {
            var sourceBuffer = sourceBuffer
        ...
        private mutating func tent(sourceBuffer: vImage_Buffer, format: vImage_CGImageFormat) {
            var sourceBuffer = sourceBuffer
            //        let startTime = mach_absolute_time()
        ...
        private mutating func box(sourceBuffer: vImage_Buffer, format: vImage_CGImageFormat) {
            var sourceBuffer = sourceBuffer
            //        let startTime = mach_absolute_time()
        ...
        private mutating func multi(sourceBuffer: vImage_Buffer, format: vImage_CGImageFormat) {
            var sourceBuffer = sourceBuffer
